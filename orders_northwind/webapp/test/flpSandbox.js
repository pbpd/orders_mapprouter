		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#iopbordersnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iopbordersnorthwind-display": {
								"semanticObject": "iopbordersnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=io.pb.ordersnorthwind",
									"url": sap.ui.require.toUrl("io/pb/ordersnorthwind")
								}
							}
						}
					}
